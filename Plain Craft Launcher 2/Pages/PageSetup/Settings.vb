...
Public Class Settings
    ...
    Public Shared ReadOnly Entries As Dictionary(Of String, Setting) = (New List(Of Setting) From {
        ...
        New Setting("SystemProxyPrefer", 1, Source:=Sources.Registry),
        New Setting("SystemProxyUser", "", Source:=Sources.Registry, Encrypted:=True),
        New Setting("SystemProxyPassword", "", Source:=Sources.Registry, Encrypted:=True),
        New Setting("SystemProxyBypass", "", Source:=Sources.Registry),
        New Setting("SystemProxyAddress", "", Source:=Sources.Registry),
